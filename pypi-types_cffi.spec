...
Source0  : https://files.pythonhosted.org/packages/f7/ad/ff634c50272e7d2a4063931f9c80c2d6e1a936e361bcc8531889efe540ce/types_cffi-1.17.0.20250319.tar.gz
...
%prep
%setup -q -n types_cffi-1.17.0.20250319
cd %{_builddir}/types_cffi-1.17.0.20250319
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742394471
